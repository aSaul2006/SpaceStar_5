...
#ifndef PHYSICSENGINE_PCONTACTS_H
#define PHYSICSENGINE_PCONTACTS_H
...
namespace PhysicsEngine {
    ...
    protected:
         ...
         */
        void resolve(double dElapsedFrameTime);
    ...
    private:
         ...
         */
        void resolveVelocity(double dElapsedFrameTime);

        /**
         * Handles the interpenetration resolution for this contact.
         */
        void resolveInterpenetration(double dElapsedFrameTime);
