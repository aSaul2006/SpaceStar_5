...
public:
	...
	void ChangeState(State<entity_type>* pNewState)
	{
		...
		//keep a record of the prev state
	...
	//return true if the cur state type is equal to the type of the passed class parameter
	bool isCurState(const State<entity_type>& st)const;
};
